...
// ForceRefreshAuth refreshes one credential synchronously, including disabled
// credentials that the background scheduler intentionally skips. Management
// quota probes use this to avoid probing with an expired OAuth access token.
